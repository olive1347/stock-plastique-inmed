...
Dépendances :
    pip install streamlit anthropic pandas pillow
...
def analyser_etiquette(image_bytes: bytes, mime_type: str = "image/jpeg") -> dict:
        ...
        messages=[
            {
                ...
                "content": [
                    ...
                    {
                        "type": "text",
                        "text": "Analyse cette étiquette de produit de laboratoire.",
                    },
                ],
            }
        ],
    ...
    # Sécurité : retirer éventuels blocs ```json
    ...
    st.markdown(
        """<div class="lab-header">
            <div>
                ...
                <p>INMED — Inventaire par vision IA · Propulsé par Claude Vision</p>
            </div>
        </div>""",
        unsafe_allow_html=True,
    )
